...
const TEXT = {
  ...
  TH: {
    ...
    faqs: [
      ...
      { q: "คอร์สมีออนไลน์ไหม?", a: "มีครับ! ทุกคอร์สมีออนไลน์ 24/7 บางคอร์สมีตัวเลือกออนไซต์ในเชียงใหม่ด้วย" },
      { q: "มีนโยบายคืนเงินไหม?", a: "เรามีการรับประกันคืนเงิน 7 วัน หากคุณไม่พอใจกับคอร์ส" },
      { q: "ได้รับใบรับรองไหม?", a: "มีครับ ทุกคอร์สมีใบรับรองการจบหลักสูตร ใบรับรอง Aviation และ Business English ได้รับการยอมรับจากนายจ้าง" },
